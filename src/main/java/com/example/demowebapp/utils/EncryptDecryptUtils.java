...
public class EncryptDecryptUtils {
    ...
    private static final String SECRET_KEY_1 = "TimaF$HUy2A#D%kd"; // ssdkF$HUy2A#D%kd
    private static final String SECRET_KEY_2 = "TimaSEvR5yAC5ftB"; // weJiSEvR5yAC5ftB
    ...
    public static void main(String[] args) throws NoSuchPaddingException, UnsupportedEncodingException, NoSuchAlgorithmException,
        ...
        String d = cryptUtils.decrypt("nF6ZNnF18QR2RIOd2cHaag==");
